...
dataInput=sio.loadmat('D:\ye\cars3\coilFull.mat')
...
maps = spectral_embedding(W, n_components=30)
######################################################################
...
select=np.array([0,72,145,217,289,361,433,505,577,649,721,793,865,937,1009])#,649,721,793,721,793,865,937, 865,937,1009,1081,1153
numlabel=40
numlabel_val=30
...
for i in range(Ns[0]):
    ...
    print(train_mask2[select[i]:select[i] + numlabel])
for i in range(Ns[0]):
...
# print(metrics.adjusted_mutual_info_score(labels, srcLabel))
